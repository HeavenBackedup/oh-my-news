...
public class UserFont {
    ...
    private int fans;
    public UserFont(int id, int isDelete, String username, String password, String email, String[] address, String imageUrl, String signature, String announcement, Date date, String nickname, int isLimit,int followers,int fans) {
        this.id = id;
