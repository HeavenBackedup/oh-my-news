...
public class UserFontWrite {
    ...
    private int fans;
    public UserFontWrite(int id, int isDelete, String username, String password, String email, String[] address, Integer media_id, String signature, String announcement, Date date, String nickname, int isLimit,int followers,int fans) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        UserFontWrite user = (UserFontWrite) o;
