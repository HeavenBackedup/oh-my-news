...
public class PrivateMsgController extends BaseAction{
    ...
    public Object getPrivateMsg(@RequestBody Map inputMap){
        //用户自己的ID
...
//        selectedValue=inputMap.get("selectedValue").toString();
    ...
    public Object getExMsg(@RequestBody Map inputMap){
        //用户自己的ID
    ...
    public Object postPrivateMsg(@RequestBody Map inputMap){
        //用户自己的ID
        Integer myUserId = Integer.parseInt(inputMap.get("userId").toString());
